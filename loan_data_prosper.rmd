...
There is an even split between homeowners and non-homeowners. The stated monthly
income is skewed to the right, but the log transformation produces a normal
distribution. There are very large outliers in the stated monthly income data
so the top 1% of data was trimmed for the plot.
...
```{r echo=FALSE}
loans$CreditScoreRangeLower <- NULL
```
...
The number of open credit lines is a fairly normal distribution. The
distribution of amount delinquent is, alternatively, clearly skewed to the
right.
